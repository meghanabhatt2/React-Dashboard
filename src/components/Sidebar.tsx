      ...
      <div className="flex">
        ...
        >
          ...
          <div className="flex flex-col items-center mt-[15px] mb-[25px]">
            ...
            {/* User Name */}
            <p className="mt-2 text-center text-white cursor-pointer">
              User Name
            </p>
          </div>
          <ul className="space-y-4 p-4">
            <li>
              <a
                href="#"
                className="text-white hover:text-[#C890A7] cursor-pointer"
              >
                Privacy
              </a>
            </li>
            ...
            <li>
              <a
                href="#"
                className="text-white hover:text-[#E0E0E0] cursor-pointer"
              >
                Orders
              </a>
            </li>
        ...
        <div className="flex-1 p-6">
          ...
          <button className="text-gray-400 text-3xl" onClick={toggleSidebar}>
            &#9776; {/* Hamburger icon */}
          </button>
        </div>
      </div>
